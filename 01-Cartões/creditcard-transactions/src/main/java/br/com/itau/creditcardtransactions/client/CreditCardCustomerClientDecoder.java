...
public class CreditCardCustomerClientDecoder implements ErrorDecoder {
    private final static Logger LOGGER = Logger.getLogger(CreditCardCustomerClientDecoder.class.getName());
